...
| `enable_secure_boot`                     | `true` for yes, `false` for no                                                                                   | Enable Secure Boot                                                                                                                                                                                                                                                                              |
| `enable_vtpm`                     | `true` for yes, `false` for no                                                                                   | Enable VTPM                                                                                                                                                                                                                                                                            |
| `enable_integrity_monitoring`                     | `true` for yes, `false` for no                                                                                   | Enable integrity monitoring                                                                                                                                                                                                                                                                              |
